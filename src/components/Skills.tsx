...
export default function Skills() {
  const educations = [
    {
      name: "Tecnólogo em Analise e Desenvolvimento de Sistemas | FATEC Americana",
    },
    {
      name: "React do zero a maestria | UDEMY: Matheus Battisti – 28,5 horas ",
    },
    {
      name: "Spring boot, hibernate, REST, JWT, MySql | UDEMY: Nélio Alves – 31,5 horas",
    },
    {
      name: " ITE- I.T. Essentials Hardware e Software | CISCO NETWORKING ACADEMY",
    },
    {
      name: "CCNA 1- Fundamentos de Redes | CISCO NETWORKING ACADEMY",
    },
      ...
      <div className="container mx-auto max-w-4xl p-4 py-12">
        <div className="relative mb-4 p-4 text-center">
          ...
          <p className="relative text-sm text-gray-700">
             React.js | Vue.js | Node.js | Java | MySQL | JavaScript 
          </p>
