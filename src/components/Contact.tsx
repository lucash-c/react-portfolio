...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 19 99141-4411",
      link: "https://wa.me/5519991414411?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "lucash_c@yahoo.com.br",
      link: "mailto:lucash_c@yahoo.com.br?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Americana-SP",
      description: "Antonio Zanaga 1",
      link: "https://goo.gl/maps/uJ8wdKZGyE9Yx8f8A",
